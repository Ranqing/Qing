...
template<class T>
inline T NRSQR(const T a) {return a*a;}

template<class T>
inline const T &NRMAX(const T &a, const T &b)
{return b > a ? (b) : (a);}

inline float NRMAX(const double &a, const float &b)
{return b > a ? (b) : float(a);}

inline float NRMAX(const float &a, const double &b)
{return b > a ? float(b) : (a);}

template<class T>
inline const T &NRMIN(const T &a, const T &b)
{return b < a ? (b) : (a);}

inline float NRMIN(const double &a, const float &b)
{return b < a ? (b) : float(a);}

inline float NRMIN(const float &a, const double &b)
{return b < a ? float(b) : (a);}

template<class T>
inline T NRSIGN(const T &a, const T &b)
{return b >= 0 ? (a >= 0 ? a : -a) : (a >= 0 ? -a : a);}

inline float NRSIGN(const float &a, const double &b)
{return b >= 0 ? (a >= 0 ? a : -a) : (a >= 0 ? -a : a);}

inline float NRSIGN(const double &a, const float &b)
{return (float)(b >= 0 ? (a >= 0 ? a : -a) : (a >= 0 ? -a : a));}

template<class T>
inline void NRSWAP(T &a, T &b)
{T dum=a; a=b; b=dum;}
...
typedef complex<double> NRComplex; // default complex type
...
typedef const NRvector<NRComplex> VecComplex_I;
typedef NRvector<NRComplex> VecComplex, VecComplex_O, VecComplex_IO;
